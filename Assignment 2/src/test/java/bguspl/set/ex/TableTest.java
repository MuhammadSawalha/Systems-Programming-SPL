...
public class TableTest {
    ...
    @Test
    void placedTokensTest() {
        /*for place token*/
        for (int i = 0; i < 3; i++) {
            table.placeToken(0, i);
            assertEquals(true, table.tokensOnTable[i][0]);
        }
    }
    @Test
    void placeCardTest(){
        ...
        for(int i=0;i<12;i++){
           assertEquals(i,table.slotToCard[i]);
        }
    }
    @Test
    void removeTokensTest(){
        /*for remove token*/
        for (int i = 0; i < 3; i++) {
            table.removeToken(0, i);
            assertEquals(false, table.tokensOnTable[i][0]);
        }
